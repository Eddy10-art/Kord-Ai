...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-2kfGOlnuD8J0pYZP',
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2349045411695",
    ...
    RENDER_API_KEY: process.env.RENDER_API_KEY || "Edicity"
